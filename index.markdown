  ...
  {% for paper in site.data.papers %}
    <li class="pub-item">
      <div class="pub-thumb">
        {%- if paper.cover -%}
          <img
            src="{{ '/assets/img/journals/' | append: paper.cover | append: '-90.webp' | relative_url }}"
            srcset="{{ '/assets/img/journals/' | append: paper.cover | append: '-90.webp' | relative_url }} 1x, {{ '/assets/img/journals/' | append: paper.cover | append: '-180.webp' | relative_url }} 2x" 
      ...
      <div class="pub-body">
        ...
        {% endif %} -->
        <div class="pub-authors">{{ paper.author}}</div>
        <div class="pub-venue">
